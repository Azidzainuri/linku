  ...
  var nolBelakang = 0;
  let settingTeks = {
    "empty cart": "Keranjang Anda masih kosong!",
    "sub total": "Sub Total",
    "berat": "berat",
    "double product": "Produk ini sudah tersedia di keranjang Anda",
    "set new product": "Produk berhasil ditambahkan",
  };
  ...
  $("#checkout-instanlink .tombol-close, .tombol-bukatutup").click(function(){
  ...
  $(".content-instanlink").each(function(){
    ...
    $("#pilihan-satu .pilihan-varian1-satu li").each(function(i){
      ...
      } else if (dataPilihan[1] != undefined && dataPilihan[1] != "off"){
        var harga = dataPilihan[1];
      }
      $(this).attr("data-normal-price", harga);
      if (dataPilihan[2] != undefined && dataPilihan[2] == "off"){
        $(this).attr("class", "pilihan-habis");
        $(this).attr("data-pilihan", dataPilihan[2]);
        $(this).attr("title", "Maaf "+ titlePilihan + " " + dataPilihan[0] + " sudah habis, harap pilih yang lain");
      }
